...
task2 = Task.new(name: "Démolir les murs", category: 'Maçonnerie', description: "Casser les murs non portants", room_id: room1.id, status: "En cours", position: 1, start_date: "2022-09-05 00:00:00 UTC" , end_date: "2022-09-15 00:00:00 UTC", user_id: user2.id)
task3 = Task.new(name: "Refaire la plomberie", category: 'Plomberie', description: "Refaire tuyaux de la cuisine", room_id: room1.id, status: "En cours", position: 2, start_date: "2022-09-05 00:00:00 UTC" , end_date: "2022-09-10 00:00:00 UTC", user_id: user7.id)
task4 = Task.new(name: "Prises murales", category: 'Electricité', description: "Mise en route compteur électrique", room_id: room1.id, status: "Faite", position: 1, start_date: "2022-09-10 00:00:00 UTC" , end_date: "2022-09-15 00:00:00 UTC", user_id: user5.id)
